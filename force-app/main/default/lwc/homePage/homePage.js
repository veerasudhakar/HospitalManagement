...
export default class homePage extends NavigationMixin(LightningElement) {
    ...
    getPageReferenceParameters(currentPageReference) {
      ...
      patientInfo;
          ...
          @wire(getPicklistValues, { recordTypeId: '$patientInfo.data.defaultRecordTypeId', fieldApiName: 'Patient__c.Gender__c' })
...
*/
  ...
  handleClick() {
    ...
    if (selectedDate > new Date().setHours(0, 0, 0, 0) || selectedDate.toDateString() == new Date().toDateString()) {
      ...
      if (this.firstName && this.lastName && this.email && this.address && this.conNum && this.selectedSlot &&this.dateOFBirth &&this.age) {
